...
const PasswordResetRequest = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/frontend_ai/verify-otp', { state: { user_id: response.data.user_id, purpose: 'password_reset' } });
    } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white p-6 md:p-8 rounded-2xl shadow-lg w-full max-w-md">
        ...
        <h2 className="text-2xl md:text-3xl font-bold text-gray-800 text-center mb-2">Reset Password</h2>
